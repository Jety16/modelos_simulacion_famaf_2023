...
def pvalor_sim(Nsim, P, n, k, t_valor):
    ''' Nsim numeros de simulaciones, P probabilidades de F teorica, n tamaño muestra, k valores que toma la variable
    '''
...
pvalor = pvalor_chi2([158, 172, 164, 181, 160, 165], [1/6, 1/6, 1/6, 1/6, 1/6, 1/6], 1000, 6)
print(f"Usando la aproximacion de chi-cuadrada tenemos que el p-valor es {pvalor}")

t_valor = t_estadistico([158, 172, 164, 181, 160, 165], [1/6, 1/6, 1/6, 1/6, 1/6, 1/6], 1000, 6)
pvalorsim = pvalor_sim(10000, [1/6, 1/6, 1/6, 1/6, 1/6, 1/6], 1000, 6, t_valor)
